    ...
    <div className={`min-h-screen transition-all duration-300 ${
      ...
      <div className="max-w-3xl mx-auto pt-24 sm:pt-32 pb-16 sm:pb-24 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-600">
            {isSignedIn ? 'Welcome Back!' : 'Convert Word to PDF'}
          </h1>
          <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-8 sm:mb-12 max-w-2xl mx-auto">
            {isSignedIn 
              ? 'Upload your DOC or DOCX file and convert it to a high-quality PDF in seconds.'
              : 'Sign in to start converting your Word documents to PDF with ease.'}
          </p>
          ...
          <SignedOut>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
              <Link
                to="/sign-up"
                className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-300 flex items-center justify-center space-x-2 w-full sm:w-auto"
              >
              ...
              <Link
                to="/sign-in"
                className="px-6 py-3 border border-blue-600 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/30 font-medium rounded-lg transition-all duration-300 flex items-center justify-center space-x-2 w-full sm:w-auto"
              >
        ...
        {status.message && (
          <div className="max-w-2xl mx-auto mt-4">
            <div
              className={`p-3 sm:p-4 rounded-xl text-sm sm:text-base animate-fade-in flex items-center justify-center space-x-2 transition-all duration-300 border ${
                status.type === "success"
                  ? darkMode
