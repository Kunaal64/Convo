          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-16 sm:mb-24 relative z-10">
              <Link to="/signin" className="relative z-10 w-full sm:w-auto">
                <Button size="lg" className="w-full sm:w-auto px-6 sm:px-8 py-4 sm:py-6 text-base sm:text-lg bg-white text-gray-900 hover:bg-white/90 transition-all duration-300">
                  Sign In
                </Button>
              </Link>
              <Link to="/signup" className="relative z-10 w-full sm:w-auto">
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="w-full sm:w-auto px-6 sm:px-8 py-4 sm:py-6 text-base sm:text-lg bg-transparent text-white border-white hover:bg-white/10 transition-all duration-300"
                >
                  Sign Up
                </Button>
              </Link>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mt-16 sm:mt-24 lg:mt-32 relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="bg-white/5 hover:bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/10 shadow-lg transition-all duration-300 hover:shadow-xl"
              >
